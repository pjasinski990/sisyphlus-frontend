...
const inputFieldClasses = 'block w-full px-3 py-2 border border-surface-1 bg-surface-1/30 rounded-sm shadow-sm placeholder-muted focus:outline-none focus:border-surface-3 focus:shadow-lg';
