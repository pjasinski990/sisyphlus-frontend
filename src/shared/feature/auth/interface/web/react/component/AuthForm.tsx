...
const inputFieldClasses = 'block w-full px-3 py-2 border border-secondary-1 bg-secondary-1/30 rounded-sm shadow-sm placeholder-muted focus:outline-none focus:border-secondary-3 focus:shadow-lg';
